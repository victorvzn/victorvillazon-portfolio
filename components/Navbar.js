  ...
  return (
    <header className='sticky top-0 z-10 backdrop-blur-sm bg-slate/20'>
      <div  className='max-w-6xl mx-auto flex justify-between items-center py-4'>
        <Link className="cursor-pointer" href="/" alt='Logo Victor Villazón'><Logo /></Link>
        <nav className=''>
          <ul className='flex justify-center gap-10'>
            ...
            <li>
              <Link href="https://github.com/victorvzn" target='_blank' alt="Github Victor Villazón">
            ...
            <li>
              <Link href="https://www.linkedin.com/in/victorvzn" target='_blank' alt="Linkedin Victor Villazón">
