...
export default function Home() {
  ...
  const [cards, setCards] = useState([
    {
      ...
      content: 'Reto de código en el que demostré mi habilidad usando TDD aplicando principios SOLID y Clean Code',
      tags: ['React', 'Typescript', 'Vite', 'Vitest', 'Jest', 'TDD', 'testing-library/react', 'Cypress', 'ESLint', 'SOLID Principles', 'Clean Code'],
      links: {
        live: 'https://github.com/victorvzn/tdd-score-board-react',
    ...
    },
    {
      ...
      content: 'Reto de maquetación desde frontendmentor hecho con Tailwind',
      tags: ['Vue3', 'Vite', 'Pinia', 'Tailwind'],
      links: {
  ...
  const [skills, setSkill] = useState([
    {
      name: 'GNU/Linux',
      colors: 'bg-white/20 hover:bg-neutral-800 text-white',
      type: 'competent'
    },
    {
      name: 'HTML',
      colors: 'bg-white/20 hover:bg-[#e34f26] text-white',
      type: 'competent'
    },
    {
      name: 'CSS',
      colors: 'bg-white/20 hover:bg-[#1b73ba] text-white',
      type: 'competent'
    },
    {
      name: 'Sass',
      colors: 'bg-white/20 hover:bg-[#CF649A]',
      type: 'competent'
    },
    {
      name: 'Tailwind',
      colors: 'bg-white/20 hover:bg-[#06b6d4]',
      type: 'competent'
    },
    {
      name: 'Javascript',
      colors: 'bg-white/20 hover:bg-[#f0db4f] hover:text-[#323330]',
      type: 'competent'
    },
    {
      name: 'ESNext',
      colors: 'bg-white/20 hover:bg-neutral-800',
      type: 'competent'
    },
    {
      name: 'Typescript',
      colors: 'bg-white/20 hover:bg-[#007acc] hover:text-white',
      type: 'competent'
    },
    {
      name: 'JWT',
    ...
    {
      name: 'Vitest',
      colors: 'bg-white/20 hover:bg-[#FCC72B] hover:text-black',
      type: 'competent'
    },
    {
      name: 'Jest',
      colors: 'bg-white/20 hover:bg-[#99425b]',
      type: 'competent'
    },
    {
      name: 'Cypress',
      colors: 'bg-white/20 hover:bg-[#04C38E]',
      type: 'competent'
    },
    {
      name: '',
    ...
    {
      name: 'React.js',
      colors: 'bg-white/20 hover:bg-[#61dafb] hover:text-white',
      type: 'competent'
    },
    {
      name: 'Next.js',
    ...
    {
      name: 'Redux',
      colors: 'bg-white/20 hover:bg-[#764ABC]',
      type: 'competent'
    },
    {
      name: '',
    ...
    {
      name: 'Vue.js',
      colors: 'bg-white/20 hover:bg-[#4dba87]',
      type: 'competent'
    },
    {
      name: 'Vuex',
    ...
    {
      name: 'Pinia',
      colors: 'bg-white/20 hover:bg-[#ffd859] hover:text-black',
      type: 'competent'
    },
    {
      name: '',
    ...
    {
      name: 'Git',
      colors: 'bg-white/20 hover:bg-[#DE4C36]',
      type: 'competent'
    },
    {
      name: '',
        ...
        <div className='flex flex-col md:flex-row'>
          <section className='w-full md:w-2/4 flex flex-col gap-10 order-last md:order-none'>
            <div className='flex flex-col pl-4 gap-8 md:border-l-amber-400 md:border-l-8 '>
              <div>
                <h2 className='text-3xl font-light'>Hola, soy</h2>
                <h1 className='text-5xl font-black'>Victor Villazón</h1>
              </div>

              <div className='font-ligth text-base'>Desarrollador frontend especializado en Javascript, Typescript, React.js y Vue.js</div>
              ...
              <div className='flex flex-col gap-4 text-base'>
                ...
                <ul className='list-disc ml-7'>
                  <li className='mb-4'>
                    <strong>Competente:</strong>
                    <div className='grid grid-cols-5 gap-2 mt-3'>
                      {skills && skills.filter(skill => skill.type.includes('competent')).map((skill, index) => (
                        <span
                          className={`${skill.colors} text-sm font-semibold px-2.5 py-0.5 rounded text-center transition ease delay-75 flex justify-center items-center`}
                  ...
                  <li>
                    ...
                    <div className='grid grid-cols-5 gap-2 mt-3'>
                      {skills && skills.filter(skill => skill.type.includes('familiar')).map((skill, index) => (
                        <span
                          className={`${skill.colors} text-sm font-semibold px-2.5 py-0.5 rounded text-center transition ease delay-75 flex justify-center items-center`}
                          key={index}>{skill.name}</span>
                        ))}
