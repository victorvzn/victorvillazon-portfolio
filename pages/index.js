...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className='h-max max-w-6xl mx-auto flex flex-col mt-10 md:mt-12'>
        <div className='flex flex-col md:flex-row'>
          <section className='w-full md:w-2/4 flex flex-col gap-10 order-last md:order-none'>
            <div className='flex flex-col pl-4 gap-8 md:border-l-amber-400 md:border-l-8'>
              <div>
                <h2 className='text-4xl font-light'>Hola, soy</h2>
                <h1 className='text-6xl font-black'>Victor Villazón</h1>
              </div>

              <p className='font-ligth text-xl'>Desarrollador frontend especializado en Javascript, Typescript, React.js y Vue.js</p>
